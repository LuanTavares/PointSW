...
public:
    ...
    void setupUi(QMainWindow *TelaPrincipal)
    {
        ...
        filaDeProducao->setHorizontalHeaderItem(6, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        __qtablewidgetitem7->setFont(font);
        filaDeProducao->setHorizontalHeaderItem(7, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        __qtablewidgetitem8->setFont(font);
        filaDeProducao->setHorizontalHeaderItem(8, __qtablewidgetitem8);
        filaDeProducao->setObjectName(QStringLiteral("filaDeProducao"));
        filaDeProducao->setGeometry(QRect(10, 0, 1241, 601));
    ...
    void retranslateUi(QMainWindow *TelaPrincipal)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem5 = filaDeProducao->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("TelaPrincipal", "Tempo de Setup", 0));
        QTableWidgetItem *___qtablewidgetitem6 = filaDeProducao->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("TelaPrincipal", "Tempo de Produ\303\247\303\243o", 0));
        QTableWidgetItem *___qtablewidgetitem7 = filaDeProducao->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("TelaPrincipal", "Paradas", 0));
